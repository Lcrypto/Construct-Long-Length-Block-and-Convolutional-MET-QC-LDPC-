...
For all simulation figure we use 2 bit soft demodulator results under 4 bit grid (simplest demodulator, futher simplication to 1 bit demodulator only work for hard decoder - like Bit-flipping). 
